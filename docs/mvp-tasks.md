...
- ~~**Shaw OHAE period chapter date-ranges**~~ ✅ — 12-row transcription of the dated-period chapter banners (chapters 3–10 and 12–15) in `sources/shaw-ohae-2000/reconciled.jsonl`. `sub_periods: []` on every row — Shaw's chapter banners do not enumerate sub-period BCE boundaries; Amarna/Ramesside/Saite sub-period spans must come from a different source in Phase A. PR #32.
