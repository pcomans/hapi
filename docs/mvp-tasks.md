...
2. 🟡 **Leprohon 2013** chunk 1 (any dynasty group) — establishes the primary titulary authority that every other ruler-referencing source validates against. Gates D&H Ch 4 and any further pharaoh.se cross-validation work.
