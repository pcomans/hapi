...
- ~~**Ryholt 1997 SIP political tables**~~ ✅ — 157-row extraction of Ryholt's Part VI Catalogue of Attestations + Chronological Tables (physical PDF pp. 336–416) in `sources/ryholt-1997-sip/reconciled.jsonl`. Every king in Dynasties 13–17 plus unattributed bucket, with five-name titulary, anglicised nomen/prenomen from Chronological Tables, BCE dates, polity per dynasty, and `pdf_pages` range citation. Pipeline: Gemini 3.1 Pro OCR → three parallel Claude Code subagents → deterministic majority-vote merge. Per ADR-017. PR #TBD.
