...
Beckerath catalogs all of these. Wikidata blends them inconsistently — treating the Wikidata `rdfs:label` as canonical produces nonsense like "Cheops" sitting next to "Amenhotep III" in the same UI list.
...
Beckerath's *Handbuch der ägyptischen Königsnamen* is the citation backbone for both the canonical display name and the titulary contents. Wikidata is captured for the Q-ID and as an additional alias source, but not trusted for the canonical name.
