...
Each ruler entity in `pipeline/pipeline/authority/rulers.json` has exactly one canonical display name: **the Conventional English Display Form** — the birth name in its modern English form.
