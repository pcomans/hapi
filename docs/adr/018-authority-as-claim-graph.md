...
**Declared deviations from strict CRM 7.1.3.** These are conscious choices, not oversights; each is justified and listed here so the rest of the ADR can use them without re-explaining.
