...
4. **Tests assert values, not absence of errors.** A test that checks "it doesn't crash" is hiding bugs. Assert specific field values against known fixture data.
