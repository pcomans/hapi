...
- `is_uncertain_attribution: bool` — True for `(?)` uncertainty markers (3 rows: 14.g, 17.7, Abyd.15). The `(?)` glyph is stripped from `nomen` / `prenomen`; the typed flag carries the information.
