...
- **Chunk 12** (this PR): Saqqâra § I.L-N royal complexes — Shepseskaf (Dyn IV Mastabat el-Faraʿun), Userkareʿ Khenzer (Dyn XIII), anonymous Dyn XIII southern pyramid-enclosure. PM III.2 physical pp.73–76 / printed pp.433–436. 3 rows. Closes the back-half of PM III.2 § I PYRAMIDS that chunks 4 (sections F–K) and 5 (sections A–E) left open. First chunk to emit `dynasty: "13"` (Dyn XIII Second Intermediate Period).
