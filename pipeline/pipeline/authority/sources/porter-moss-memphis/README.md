...
- **Chunk 9** (this PR): Gîza § III.A West Field continuation — CEMETERY G 3000 (Fisher's "Minor Cemetery", Penn Coxe Expedition 1915). PM III.1 § III.A, physical pp.92–96 / printed pp.95–99. 14 rows (13 Shape-1 named + 1 Shape-2 bare-suffix). Essentially a Dyn-VI assemblage: ka-servants, waʿb-priests, judges. Highlights: G 3008 Snefruḥotp + wife Khenut called Inti, G 3050 ʿAnkh ka-servant, G 3086 Ruz Prophet of Khufu / Raʿzedef / Khephren, G 3098 IYMERERY+NEFERḤETPES-WER (chunk-9 single-row annexe-pair: distinct from chunk-7's separately-headworded G 2100-I-annexe). 8 tie-break-overrides cover wife-clause role strings + Ḥathor underdot normalisation across G 3008/G 3050/G 3093/G 3098.
- **Chunk 10+** (future PRs): Gîza West Field continuation — Junker Cemetery (West + East) named tombs (Irty, ʿAnkh, Iyherkherui, Aankhu, Sonb I, etc. — name-headword convention, NOT Reisner G-numbered) + Steindorff Cemetery, then G 4000 (Hemiunu) / G 5000 South Echelon / G 6000. Then § III.D Menkaureʿ Cemetery + § III.E Central Field OK portion (chunk 3 already did the Saite intrusions).
