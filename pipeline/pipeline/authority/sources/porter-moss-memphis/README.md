...
- **Chunk 13+** (future PRs): Gîza West Field continuation — Junker Cemetery (East) named tombs, then G 4000 (Hemiunu) / G 5000 South Echelon / G 6000. Then § III.D Menkaureʿ Cemetery + § III.E Central Field OK portion (chunk 3 already did the Saite intrusions).
