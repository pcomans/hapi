...
- **Chunk 6** (this PR): Gîza § III.A West Field, Junker low-thousands cemeteries — G 1000 / G 1100 / G 1200 / G 1300 / G 1400 / G 1500 / G 1600 / G 1900. PM III.1 § III.A, physical pp.46–62 / printed pp.49–65. 54 rows (30 Shape-1 named primary + 24 Shape-2 bare-suffix). First West Field chunk; first Shape-3 compound twin-mastaba in the West Field (G 1452+1453 ZADUWAʿ); first underdot-Ḥ glyph normalisation for non-royal names (Meḥyt in G 1201).
- **Chunk 7+** (future PRs): Gîza West Field continuation — § III.A G 2000-G 2200 with Mastaba G 2220; then G 2300-G 2500 (Hemiunu's annexes); then G 4000 (Hemiunu) / G 5000s / G 6000. Multiple sub-chunks, ~30–50 rows each. Then § III.D Menkaureʿ Cemetery + § III.E Central Field OK portion (chunk 3 already did the Saite intrusions).
