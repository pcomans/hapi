...
- **Chunk 17** (this PR; halves 17a + 17b): Gîza § III.B EAST FIELD remainder — `CEMETERY G 7000` continuation (Reisner Excavation, Harvard-Boston Expedition). Picks up where chunk 2 left off at G 7150. PM III.1 § III.B, physical pp.188–211 / printed pp.191–214. 52 rows total: 17a covers G 7152→G 7540 (~20 rows, physical pp.188–196 / printed pp.191–199); 17b covers G 7550→G 7948 (~32 rows, physical pp.197–207 / printed pp.200–210). Headlined by the Khufu royal-family core (Ḥarzedef G 7210+7220, Ḥetepḥeres II G 7350, Meresʿankh II G 7410+7420, Meresʿankh III G 7530+7540) and ʿAnkh-ḥaf the Vizier of Khephren at G 7510. Multiple Shape-4 `+`-joint-twins (chunks-14 G 4811 convention: multiple tomb numbers ≠ multiple occupants → `is_joint_burial: false`, second number in `tomb_aliases`). One true multi-occupant joint burial at G 7820 (Iynefer + wife Nefertkau → `is_joint_burial: true`). Letter-suffix tomb_id introduced for G 7711a. 30 tie-break-overrides resolve 1/1/1 ties on joint-twin notes, hedged parent roles, body-prose sub-entry nulls, diacritic normalisation. CHUNK17_CORRECTIONS empty pending reviewer pass. Total reconciled: 424 rows (was 372).
- **Chunk 18+** (future PRs): trailing LG 63–80 named tombs + Rock-cut tombs excavated by Service des Antiquités + Tombs north of Great Sphinx (printed pp.208–214, ~23 entries still in the CEMETERY G 7000 PM page range that chunk 17 didn't pick up due to no G-number prefix). Then § III.C CEMETERY G I S + § III.D QUARRY CEMETERY WEST OF SECOND PYRAMID + § III.E Central Field OK portion.
