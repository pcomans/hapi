...
- **`name_variants: list[str]`** — extracted from `(...)` parens in `name`. The canonical `name` has the parens stripped (12.01 `"Ammenemes (Amen-em-hat) I."` → `name="Ammenemes I."` + `name_variants=["Amen-em-hat"]`; 19.01 multi-variant `"Ramses (Ra-mes-su, griech. Ramessês) I."` → `name_variants=["Ra-mes-su", "griech. Ramessês"]`). Bare-paren names like 22.07 `"(Schoschenq IIIa.)"` are uncertainty markers and stay verbatim.
