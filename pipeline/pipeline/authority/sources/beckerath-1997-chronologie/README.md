...
- **`is_anti_king: bool`** — True for 6 rows where Beckerath flags the king as Gegenkönig (in `notes_from_beckerath`) OR the name itself is parens-wrapped (22.07). Authoritative set: `test_179_anti_king_canonical_set`.
