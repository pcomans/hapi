...
|---|---|---|
| baud-3 | ✅ all fields match PDF p.17 | 7 titles, French spouse name, Mastaba G 7650, PM 200-201, date "Rêkhaef au plus tard", and the notes_from_baud PARENTÉ line all verbatim. |
...
The 2 reviewed rows are **no longer provisional for the citation-fidelity / transcription layer**. The remaining 38 un-sampled rows in chunk 1 **remain provisional at the chunk level** per ADR-017 step 6. Scholarly judgment fields (role vocab semantics, kinship inference, hedge calibration) across all chunk-1 rows **remain provisional** pending a future Egyptological pass.
