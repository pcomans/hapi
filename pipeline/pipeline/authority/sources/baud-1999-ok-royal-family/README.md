...
- **`roles`** = structured list of normalised OK-appropriate role codes derived from `titles_from_baud` and Baud's filiation prose. Controlled vocabulary for this source (established during chunk 1 extraction, expand across chunks): `king`, `queen`, `king's mother`, `king's wife`, `king's son`, `king's daughter`, `king's son-in-law`, `vizier`, `king's eldest son of his body`, `priest of the royal pyramid`, `priest of the king's mother`, `steward of the queen`, `sem priest`. Phase A expands to canonical titulary codes.
