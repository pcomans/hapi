...
Per ADR-017 and `docs/playbook-phase-0-ocr-transcription.md`. Six chunks landed so far (Power-and-Glory, Amarna Interlude, Ramesside sub-blocks, Head of the South, Seizers of the Two Lands, Kings and Commoners); further chunks (remaining earlier chapters) follow the same method.
