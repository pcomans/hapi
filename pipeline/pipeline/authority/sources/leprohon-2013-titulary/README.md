...
- `display_name_absence`: `{kind, printed_as} | null`. Non-null on the **8 rows where the headword is not a name** but Leprohon's designation for a king-list entry whose name is lost: `leprohon-13.49` "One Name Lost" (p. 70), `14.14` "Name Lost" (p. 76), `14.46` "Three Names Lost" (p. 79), `14.52` "Five Names Lost" (p. 79), `16.01` "Name Lost" (p. 83), `16.11` "Five Names Lost" (p. 85), `17.03` "Eight Names Lost" (p. 88), `17.12` "Three Names Lost" (p. 88). Same fact — and the same `stated_unknown` vocabulary term — as the titulary-slot `absence` above.
