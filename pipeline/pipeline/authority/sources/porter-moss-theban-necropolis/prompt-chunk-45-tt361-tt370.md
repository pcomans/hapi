...
- **`"Deir el-Baḥri"`** — Deir el-Baḥri (Ḥ-underdot preserved per PM's printed form — migrated 2026-05-23 per issue #291 from project-stripped `Deir el-Bahari`). Added to canonical list per PR #290 chunk-44 code-reviewer P3 + egyptologist P2 follow-up; PM-faithful migration completed in the same sweep that resolved issue #288.
