...
- **Chunk 7 (this PR)**: PM I.2 §§ II + III.A/C/D — **first chunk with non-numbered tombs, introduces the descriptor-id convention.** 18 rows across 5 sub-sections:
...
- **Future chunks** (each its own PR):
  ...
  - PM I.2 § X "Valley of the Queens" — `QV1`–`QV80` (numbered-tomb form, clean schema fit; one or two chunks).
