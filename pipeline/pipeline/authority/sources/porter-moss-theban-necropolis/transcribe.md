...
| 21 | PM I.1 § I "Numbered Tombs" — TT121–TT130 (homogeneous: Sh. ʿAbd el-Qurna, 10 rows; 9 Official + 1 anonymous TT129 "Name lost"; **first chunk-21 joint burial** TT122 `[Amen]ḥotp` + Amenemḥet — "both Overseers of the magazine of Amūn" — is_joint_burial=true with co_occupants=["Amenemḥet"] + parents Wazmosi/Tetisonb noted; TT127 Senemiʿoḥ usurped in Ramesside times (deriver fires is_usurped=true); TT128 PATHENFY "Mayor of Edfu, Mayor of the City"; TT130 MAY Harbour-master Tuthmosis III(?); 4 regnal-date hedges TT121/126/127/130 `(?)` on regnal date → attribution_certainty="attested" via DERIVER_OVERRIDE) | p.235–246 | p.253–264 | in-progress | (this PR) |
