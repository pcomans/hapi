...
| 28 | PM I.1 § I "Numbered Tombs" — TT191–TT200 (10 rows; 7 ʿAsâsîf TT191–TT197 + 3 Khôkha TT198–TT200; all Official; TT192 KHARUEF alt-name Senaʿa; TT194 [Ḏ]hutemhab bracket-fragment + d-bar; TT199 [Amen]arnofru bracket-fragment + (Inaccessible.) state-marker; TT200 occupant_name `Ded` (A+B 2/1 over C's `Dedi` from D ED 1 OCR); 0 CHUNK28_CORRECTIONS + 4 tie-break overrides on Amūn macron splits + 0 DERIVER_OVERRIDES) | p.297–305 | p.315–323 | in-progress | (this PR) |
