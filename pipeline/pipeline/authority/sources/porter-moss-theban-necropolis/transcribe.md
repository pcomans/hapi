...
| 19 | PM I.1 § I "Numbered Tombs" — TT101–TT110 (homogeneous: Sh. ʿAbd el-Qurna, 10 rows; two Vizier rows TT103 Dagi + TT106 Paser — both "Governor of the town and Vizier"; bracketed-fragment headword TT104 `[Ḥutnufer]` with cross-tomb-ref `shared_with_tombs: ["TT80"]` from PM `(See tomb 80.)`; d-bar TT110 `Ḏhout`; regnal-date hedge TT108 `Temp. Tuthmosis IV(?)` → attribution_certainty="attested" via DERIVER_OVERRIDE; parent-identification hedge TT110 `Pesediri(?)` → attribution_certainty="attested" via DERIVER_OVERRIDE) | p.214–227 | p.232–246 | in-progress | (this PR) |
